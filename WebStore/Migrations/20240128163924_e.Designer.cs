...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebStore.Data.Entities.Review", b =>
                {
                    ...
                    b.HasIndex("OwnerId")
                        .HasDatabaseName("ix_reviews_owner_id");
            ...
            modelBuilder.Entity("WebStore.Models.CategoryModel.CategoryFormModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_category_form_model");

                    b.ToTable("category_form_model", (string)null);
                });
            ...
            modelBuilder.Entity("WebStore.Data.Entities.Review", b =>
                {
                    b.HasOne("WebStore.Data.Entities.Account.ApplicationUser", "Owner")
                        .WithMany()
